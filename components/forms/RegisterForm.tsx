    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-12">
        <section className="space-y-4">
          <h1 className="header">환영합니다 👋</h1>
          <p className="text-dark-700">귀하에 대해 자세히 알려주십시오.</p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            ...
            <CustomFormField fieldType={FormFieldType.PHONE_INPUT} control={form.control} name="phone" label="전화번호" placeholder="(555) 123-4567" />
          </div>

          {/* BirthDate & Gender */}
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField fieldType={FormFieldType.DATE_PICKER} control={form.control} name="birthDate" label="생년월일" />
